...
public class SortSummary {
    ...
    public static void bubbleSort(int[] array) {
        ...
        while(!sorted) {
            ...
            for (int i = 0; i < array.length - 1; i++) {
                ...
                System.out.print("array index " + i + " compare " + (i+1) + " --> "+ (isChange?"change : ":"no change : "));
                Arrays.stream(array).forEach(v->System.out.print(v));
                System.out.println();
            }
    ...
    public static void insertionSort(int[] array) {
        for (int i = 1; i < array.length; i++) {
            ...
            System.out.println(" compare : " + array[j] + " value : " + array[i]);
            while(j >= 0 && current < array[j]) {
                System.out.println("changed " + array[j] + " -> index " + (j+1));
                array[j+1] = array[j];
                j--;
            }
            array[j+1] = current;
